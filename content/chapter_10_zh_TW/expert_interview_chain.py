...
class InterviewChain:
    ...
    def __call__(self) -> Any:
        ...
        system_message = """
        All content must be output in Traditional Chinese.
        You are a content SEO researcher. Previously you have summarized and extracted key points from SERP results. 
        ...
        - IMPORTANT: Return ONLY the JSON data, not the schema or any other text.

...
class ContentGenerator:
    def __init__(
        ...
        prompt = f"""
        All content must be output in Traditional Chinese. Act as a content SEO writer.
        ...
        for subheading in self.outline.sub_headings:
            ...
            while k >= 0:
                ...
                if k < 0:
                    ...
                    relevant_documents = ""
            section_prompt = f"""
            All content must be output in Traditional Chinese. You are currently writing the section: {subheading.title}
            ---
